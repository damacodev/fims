    ...
    <div id="kt_quick_actions_toggle">
      <a href="#" class="btn btn-icon btn-sm btn-clean btn-text-dark-75">
        <span class="svg-icon svg-icon-lg">
          <inline-svg
            :src="
              require('@/assets/media/svg/icons/Layout/Layout-4-blocks.svg')
            "
          />
        </span>
      </a>
          ...
          <div class="col-6">
            ...
            >
              <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                ...
                <inline-svg
                  :src="require('@/assets/media/svg/icons/Shopping/Euro.svg')"
                />
                <!--end::Svg Icon-->
              </span>
          ...
          <div class="col-6">
            ...
            >
              <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                ...
                <inline-svg
                  :src="
                    require('@/assets/media/svg/icons/Communication/Mail-attachment.svg')
                  "
                />
                <!--end::Svg Icon-->
              </span>
          ...
          <div class="col-6">
            ...
            >
              <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                ...
                <inline-svg
                  :src="require('@/assets/media/svg/icons/Shopping/Box2.svg')"
                />
                <!--end::Svg Icon-->
              </span>
              <span class="d-block font-weight-bold font-size-h6 mt-2"
          ...
          <div class="col-6">
            ...
            >
              <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                ...
                <inline-svg
                  :src="
                    require('@/assets/media/svg/icons/Communication/Group.svg')
                  "
                />
                <!--end::Svg Icon-->
              </span>
          ...
          <div class="col-6">
            ...
            >
              <span class="svg-icon svg-icon-3x svg-icon-primary m-0">
                ...
                <inline-svg
                  :src="
                    require('@/assets/media/svg/icons/Design/Color-profile.svg')
                  "
                />
                <!--end::Svg Icon-->
              </span>
