                    ...
                    >
                      <div class="symbol symbol-50 symbol-light mr-5">
                        <span class="symbol-label">
                          <inline-svg
                            :src="require(`@/assets/media/svg/${item.svg}`)"
    ...
    return {
      ...
      list1: [
        ...
        },
        {
          ...
          desc: "Most Successful Fellas",
          alt: "+4500$",
          svg: "misc/015-telegram.svg"
        },
        {
          title: "Active Customers",
          desc: "Most Successful Fellas",
          alt: "+4500$",
          svg: "misc/003-puzzle.svg"
        }
      ],
      list2: [
        {
        ...
        },
        {
          ...
          desc: "Due in 2 Days",
          alt: "-27%",
          svg: "icons/Communication/Group-chat.svg",
          type: "danger"
        },
        {
          ...
          desc: "Due in 2 Days",
          alt: "+8%",
          svg: "icons/General/Attachment2.svg",
          type: "info"
        }
      ],
      list3: [
