...
export default {
  ...
  data: () => ({
    ...
    route: {
      form: "sf211CreateItem"
    },
    form: {
      standardForm211Id: null,
      dppu: {
        id: null,
        label: null
      },
  ...
  methods: {
      ...
      self.$store
        ...
        .then(response => {
          if (response.error) {
            ...
            self.form.standardForm211Id = response.data.id;
    ...
    getById() {
      ...
      self.$store
        .dispatch("apis/get", {
          url: `/board/standard-form/211/record/${self.$route.params.iditem}`
        })
        .then(response => {
          if (response.error) {
            self.$message.error({
    ...
    handleSubmit() {
      ...
      if (self.$route.name == self.route.form) {
        ...
        _okText = "Yes, Update";
        _action = "apis/put";
        _url = `/board/standard-form/211/record/${self.$route.params.iditem}`;
      }
