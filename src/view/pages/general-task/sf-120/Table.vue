<template>
  ...
  >
    <template #toolbar>
      <b-button variant="primary" :to="{ name: 'sf120Create' }" class="mr-2">
...
import { sf120 as columns } from "@/core/datasource/columns";
