        ...
        >
          <span class="nav-icon py-2 w-auto">
            <span class="svg-icon svg-icon-3x">
              ...
              <inline-svg
                :src="require('@/assets/media/svg/icons/Home/Library.svg')"
              />
              <!--end::Svg Icon-->
            </span>
          </span>
      ...
      >
        ...
        >
          <span class="nav-icon py-2 w-auto">
            <span class="svg-icon svg-icon-3x">
              <inline-svg
                :src="require('@/assets/media/svg/icons/Media/Movie-Lane2.svg')"
              />
            </span>
          </span>
          <span
        ...
        >
          <span class="nav-icon py-2 w-auto">
            <span class="svg-icon svg-icon-3x">
              <inline-svg
                :src="
                  require('@/assets/media/svg/icons/General/Shield-check.svg')
                "
              />
            </span>
          </span>
