      ...
      <div class="card-toolbar">
        <a href="#" class="btn btn-success font-weight-bolder font-size-sm">
          <span class="svg-icon svg-icon-md svg-icon-white">
            ...
            <inline-svg
              :src="
                require('@/assets/media/svg/icons/Communication/Add-user.svg')
              "
            />
            <!--end::Svg Icon--> </span
          >Add New Member</a
                ...
                <td class="pr-0">
                  <div class="symbol symbol-50 symbol-light mt-1">
                    <span class="symbol-label">
                      <img
                        :src="require(`@/assets/media/svg/${item.text0}`)"
                ...
                <td class="pr-0 text-right">
                  ...
                  >
                    <span class="svg-icon svg-icon-md svg-icon-primary">
                      ...
                      <inline-svg
                        :src="
                          require('@/assets/media/svg/icons/General/Settings-1.svg')
                        "
                      />
                      <!--end::Svg Icon-->
                    </span>
                  ...
                  >
                    <span class="svg-icon svg-icon-md svg-icon-primary">
                      ...
                      <inline-svg
                        :src="
                          require('@/assets/media/svg/icons/Communication/Write.svg')
                        "
                      />
                      <!--end::Svg Icon-->
                    </span>
                  ...
                  >
                    <span class="svg-icon svg-icon-md svg-icon-primary">
                      ...
                      <inline-svg
                        :src="
                          require('@/assets/media/svg/icons/General/Trash.svg')
                        "
                      />
                      <!--end::Svg Icon-->
                    </span>
